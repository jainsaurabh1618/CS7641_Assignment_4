...
plt.xlabel('Gamma')
plt.title('Value Iteration - Gamma vs Execution Time')
plt.ylabel('Execution Time (s)')
plt.grid()
plt.legend()
plt.savefig("images/forest/VI_ExecutionTime.png")
plt.clf()
...
plt.title('Value Iteration - Gamma vs Reward')
plt.grid()
plt.legend()
plt.savefig("images/forest/VI_AverageRewards.png")
plt.clf()
...
plt.title('Value Iteration - Gamma vs Convergence')
plt.grid()
plt.legend()
plt.savefig("images/forest/VI_Iterations.png")
plt.clf()